      ...
      <div className="des_img `md`">
        <div className="image">
          ...
          <div>
            ...
            <InnerImageZoom src={Images} zoomType="hover" fadeDuration={0}  width={600} height={500} hasSpacer={true}/>
        ...
        <div className="buynow_btn">
          ...
          <div className="add_tocart">
            <button
              ...
              className="bg-green-600 rounded pl-10 pr-10 pt-2 pb-2 ml-2"
            >
              Reviews
            </button>
          </div>
